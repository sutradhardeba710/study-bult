                ...
                <form onSubmit={handleUpdate} className="space-y-4">
                  ...
                  <div>
                    ...
                    <CustomSelect
                      ...
                      onChange={val => setEditData({ ...editData, role: val as 'student' | 'admin' })}
                      disabled={loading}
                      options={[
                        { value: 'student', label: 'Student', emoji: '🎓', badgeClass: 'bg-blue-50' },
                        { value: 'admin', label: 'Admin', emoji: '🛡️', badgeClass: 'bg-purple-50' },
                      ]}
                    />
                  </div>
                  <div>
