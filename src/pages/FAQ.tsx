  ...
  return (
    <div className="max-w-3xl mx-auto py-12 px-4">
      ...
      <div className="space-y-2">
        <FAQItem
          question="What is Study Volte?"
          answer={
            <p>Study Volte is a platform where students can share and access question papers and academic resources from various colleges and courses. Our goal is to help students prepare better for exams by providing access to previous years' question papers.</p>
          }
        />
        ...
        <FAQItem
          question="Is Study Volte free to use?"
          answer={
            <p>Yes, Study Volte is completely free for students. We believe in making academic resources accessible to everyone.</p>
          }
        />
        ...
        <FAQItem
          ...
          answer={
            <p>If you find any inappropriate content or papers that violate our terms of service, please contact us at <a href="mailto:support@study-volte.site" className="text-primary-600 hover:text-primary-700 underline">support@study-volte.site</a> with details of the content.</p>
          }
        />
        ...
        <FAQItem
          ...
          answer={
            <p>You can contact our support team at <a href="mailto:support@study-volte.site" className="text-primary-600 hover:text-primary-700 underline">support@study-volte.site</a> or visit our <a href="/contact" className="text-primary-600 hover:text-primary-700 underline">Contact page</a>.</p>
          }
        />
      </div>
    </div>
