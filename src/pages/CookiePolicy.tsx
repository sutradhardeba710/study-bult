  ...
  return (
    <div className="max-w-4xl mx-auto py-12 px-4">
      ...
      <div className="prose prose-lg max-w-none">
        <p className="mb-4">
          This Cookie Policy explains how StudyVault ("we", "us", or "our") uses cookies and similar technologies 
        ...
        <p>
          ...
          <a href="mailto:support@studyvault.com" className="text-primary-600 hover:text-primary-700 underline">
