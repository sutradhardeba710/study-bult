            ...
            <div className="min-h-screen bg-gray-50">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                    ...
                    <section className="bg-white rounded-2xl border border-gray-100 p-8 mb-10">
                        ...
                        <p className="text-gray-600 leading-relaxed mb-4">
                            BSc question papers reward a different kind of preparation than pure memorisation. In physics, chemistry, and mathematics, marks concentrate on derivations, numerical problems, and the ability to show your working clearly — examiners award steps, not just final answers, so a partially correct derivation still earns credit. In the life sciences, botany and zoology papers lean towards labelled diagrams, well-structured descriptive answers, and precise terminology. Reading through several years of previous papers tells you which specific derivations and diagrams keep reappearing, and those are almost always the safest topics to master first.
                        </p>
                        <p className="text-gray-600 leading-relaxed mb-4">
                            A practical approach for BSc is to separate your revision into "solve" subjects and "write" subjects. For the solve subjects, treat past papers as a problem bank: rework each numerical until you can reproduce the full solution from a blank page under time pressure, because speed in the exam hall comes only from repetition. For the write subjects, build a bank of standard diagrams and definitions you can draw and state accurately, and rehearse structuring long answers into clear headed points rather than continuous paragraphs. Because most BSc courses also carry a separate practical or viva component, reviewing the theory behind common experiments while you practise past papers ties the written and practical halves of the exam together and saves duplicated effort.
                        </p>
