            ...
            <div className="min-h-screen bg-gray-50">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                    ...
                    <section className="bg-white rounded-2xl border border-gray-100 p-8 mb-10">
                        ...
                        <p className="text-gray-600 leading-relaxed mb-4">
                            BCA papers tend to mix three question types, and recognising them changes how you prepare. First are definition and short-note questions — what is normalisation, explain the OSI layers, define a primary key — where accuracy and the right technical vocabulary matter most. Second are "write a program" questions in C, C++, or Java, where examiners look for correct logic, sensible variable names, and clean structure rather than a compilable masterpiece; practising these by hand, without an IDE, is the only way to be ready. Third are diagram and dry-run questions — ER diagrams, flowcharts, tracing a data structure through an algorithm — which reward neat, labelled work. Previous year papers show you the mix your particular subject favours so you are not surprised on exam day.
                        </p>
                        <p className="text-gray-600 leading-relaxed mb-4">
                            The subjects that repeat most reliably across years are the fundamentals: data structures (stacks, queues, linked lists, sorting), DBMS (normalisation, SQL queries, ER modelling), and core programming constructs. Because these appear every year in some form, working through three or four past papers per subject and keeping a list of the recurring programs and queries gives you an unusually high-yield revision set. Solve the coding questions on paper under timed conditions, redraw the standard diagrams until they are automatic, and keep concise notes on the theory topics that show up as short notes. This turns a broad, intimidating syllabus into a focused set of patterns you have already rehearsed before you enter the exam hall.
                        </p>
