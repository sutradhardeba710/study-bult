                                        ...
                                        <div className="flex space-x-2">
                                            ...
                                            {userProfile && (
                                                <button
                                                    ...
                                                    className={`px-3 py-2 rounded-md text-sm font-medium ${likedPapers.has(paper.id || '')
                                        ...
                                        <div className="mt-2">
                                            ...
                                            {shareMenuOpen === paper.id && (
                                                ...
                                                >
                                                    ...
                                                    <a
                                                        href={`https://wa.me/?text=${encodeURIComponent('Check out this paper on Study Volte: ' + window.location.origin + '/browse?paper=' + paper.id)}`}
                                                        target="_blank"
                            ...
                            <div className="flex space-x-2">
                                ...
                                {userProfile && (
                                    <button
                                        ...
                                        className={`px-4 py-2 rounded-md ${likedPapers.has(selectedPaper.id || '')
                                            ? 'text-red-600 bg-red-50 border border-red-200'
                                            : 'text-gray-600 bg-gray-50 border border-gray-200 hover:bg-gray-100'
                                            }`}
                                    >
